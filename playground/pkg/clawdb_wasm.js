/* @ts-self-types="./clawdb_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function dump(memory_type) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(memory_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('clawdb_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
